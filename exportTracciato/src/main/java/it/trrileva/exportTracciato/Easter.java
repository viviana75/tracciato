...
public class Easter {
	...
	public final static boolean isEaster(Date date) throws YearOutOfRangeException {
		...
		return (easterYMD == dateYMD || easterYMD + 1 == dateYMD);
	}

	public final static Date find(int year) throws YearOutOfRangeException {
